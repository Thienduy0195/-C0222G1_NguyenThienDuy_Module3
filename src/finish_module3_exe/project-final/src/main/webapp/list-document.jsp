    ...
    <nav class="navbar navbar-expand-lg p-2 my-0 col ">
        <div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link text-black-50" href="#">History</a>
                </li>
            </ul>
        ...
        <table class="table table-striped " id="tableCustomer" style="border-color: #a71d2a; margin: 0; background-color: white">
            ...
            <c:forEach var="document" items="${documentList}" varStatus="doc">
                <tr>
                    ...
                    <td>
                        <a href="/document?action=edit&id=${document.documentId}&idName=${document.patientId}" target="#">
                        ...
                        <button type="button" class="btn btn-danger"
                                ...
                                onclick="infoDelete(
                                    ...
                                    <c:out value='\"${document.checkinDay}\"'/>,
                                    <c:out value='\"${document.checkoutDay}\"'/>
                                        )">
                            Delete
                        </button>
                    </td>
...
<%--                            <div id="checkin_delete"></div>--%>
                            <div id="checkout_delete"></div>
                        </div>
...
<div align="center">
    <p style="color: green; font-size: 2em">${message}</p>
</div>
</html>


<script>
    function infoDelete(documentId) {
        document.getElementById("id_delete").value = documentId;
        document.getElementById("checkout_delete").innerText = "Do you want to delete?";
    }
</script>
<script>

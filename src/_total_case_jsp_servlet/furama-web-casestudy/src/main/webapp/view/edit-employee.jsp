        ...
        <form class="content-create-form" method="post">
            ...
            <div class="form-group">
                <c:if test="${employee != null}">
                    <input type="hidden" name="customerId" value="${employee.employeeId}"/>
                </c:if>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input id="birthday" type="date" name="employeeBirthday" size="45"
            ...
            <div class="form-group">
                <label for="employeePositionId">Employee Position:</label>
            ...
            <div class="form-group">
                <label for="employeeDegreeId">Employee Position:</label>
            ...
            <div class="form-group">
                <label for="employeeDivisionId">Employee Position:</label>
